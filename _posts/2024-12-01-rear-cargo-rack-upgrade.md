---
layout: post
title: "Rear Cargo Rack Upgrade for Talaria MX5"
date: 2024-12-01 10:00:00 -0800
categories: mods
---

## KEMIMOTO Rear Rack Compatible with Talaria Sting Luggage Rack

I've been commuting downtown on my Talaria MX5 and needed a solution for carrying my motorcycle lock and chain. After searching for a rear rack that fit well and could handle the daily load, I came across the KEMIMOTO Rear Rack for Talaria Sting bikes. This rack is compatible with the MX3, MX4, and MX5, and it's exactly what I needed.

![Installed KEMIMOTO Rear Rack on Talaria MX5]({{ '/assets/img/rear-rack/IMG_2275.jpeg' | relative_url }})
...
The rack has a weight capacity of up to 12lbs and comes in a sleek black, powder-coated finish. The metal construction is solid, and the powder coating should protect it from rust and wear, especially during the rainy season. The small lip around the edges of the rack helps keep my chain from sliding around when it's wrapped around the back, providing a stable place for the lock while riding.
...
![Before Installation]({{ '/assets/img/rear-rack/IMG_2243.jpeg' | relative_url }})
...
![Pre-Installation of the Fender]({{ '/assets/img/rear-rack/IMG_2273.jpeg' | relative_url }})
...
![Rack Installed]({{ '/assets/img/rear-rack/IMG_2276.jpeg' | relative_url }})

### Final Installation

Here are two images of the final install. It's a solid fit, and the rack holds securely:

![Final Installation 1]({{ '/assets/img/rear-rack/IMG_2274.jpeg' | relative_url }})
![Final Installation 2]({{ '/assets/img/rear-rack/IMG_2275.jpeg' | relative_url }})
